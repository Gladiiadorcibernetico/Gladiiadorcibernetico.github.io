...
},
{
...
},
   {
        ...
        imagen : src="./imagenes/principe.png",
},
...
//BOTON DISABLES Y GRIS FALLIDO


/*if(contador == 0){
        
        btni.classList.add("gris");
        btni.disabled = true;
        
       
 }
if(contador >= 1){
        btni.classList.remove("gris");
        btni.enabled = true;
...
//if(contador = 0){
 //       btni.disabled = true;
   //     btniclassList.replace(boton1, gris);
     //   }
...
function accionI(){        
 ...
 btnd.addEventListener('click' , accionD );
...
volv.addEventListener('click', transicionReturn);
